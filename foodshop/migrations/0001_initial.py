    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonus_balance', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Баланс бонусов')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='foodshop.dish', verbose_name='Блюдо')),
            ],
        ),
    ]
